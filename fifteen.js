...
var background = ["mario", "luigi", "mariao2", "fog","teemo"];
...
function checkIfWon() {
    if (cell.toString() == shuffle_t.toString()) { 
        // Test the image, time and number of turns by swapping == to !=, and move the one tile
        var html = "";
